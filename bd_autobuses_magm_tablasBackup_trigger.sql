...
-- Volcando datos para la tabla bd_autobuses_magm.backup_ocupacion: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `backup_ocupacion` DISABLE KEYS */;
REPLACE INTO `backup_ocupacion` (`id_backup_ocupacion`, `id_backup_viajero`, `num_asiento`, `id_backup_reserva`) VALUES
	(32, 35, 1, 22),
	(34, 37, 5, 23);
...
-- Volcando datos para la tabla bd_autobuses_magm.backup_reserva: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `backup_reserva` DISABLE KEYS */;
REPLACE INTO `backup_reserva` (`id_backup_reserva`, `id_backup_viaje`, `id_tarjeta`, `localizador`) VALUES
	(22, 1, 11, 'FTRW'),
	(23, 2, 11, 'HOEM');
...
-- Volcando datos para la tabla bd_autobuses_magm.backup_viaje: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `backup_viaje` DISABLE KEYS */;
REPLACE INTO `backup_viaje` (`id_backup_viaje`, `id_horario`, `fecha`, `plazas_ocupadas`) VALUES
	(1, 1, '2018-03-20', 2),
	(2, 1, '2018-03-22', 1);
...
-- Volcando datos para la tabla bd_autobuses_magm.backup_viajero: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `backup_viajero` DISABLE KEYS */;
REPLACE INTO `backup_viajero` (`id_backup_viajero`, `nif`, `nombre`, `apellidos`, `fecha_nac`) VALUES
	(35, '48259583V', 'Miguel Angel ', 'Garcia', '1997-07-27'),
	(36, '48259584H', 'Montse', 'Garcia Martinez', '2000-01-26'),
	(37, '48259583V', 'Miguel Angel', 'Garcia', '2015-02-09');
